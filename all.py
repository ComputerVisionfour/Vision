...
denoise2 = cv2.medianBlur(erosion_image, 13)
...
try:
    ...
    for i in circles[0]:
        ...
        cv2.rectangle(denoise2,(x-30,y-20),(x+30,y+20),(255,255,255),2)
        img_crop = denoise2[y-20:y+20 ,x-28:x+28] # 이미지 크롭
        ...
        #elif 3000<pix_sum_cnt<3433:
            #cv2.putText(img_first, '2', (x,y), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 1)
        #elif 3342<pix_sum_cnt:
            #cv2.putText(img_first, '3', (x,y), cv2.FONT_HERSHEY_SIMPLEX, 1, (255,0,0), 1)
except:
    circles = 0
#=====================================================================
