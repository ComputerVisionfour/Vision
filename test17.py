# -*- coding: utf-8 -*-
"""
Created on Thu Nov 25 01:48:52 2021
...
img_c1 = img_first.copy()
img_c2 = img_second.copy()

#================== 이미지 선명도 증가 함수===========
def img_Contrast(img_c2):
    lab = cv2.cvtColor(img_c2, cv2.COLOR_BGR2LAB)
    l, a, b = cv2.split(lab)
...
img_gray = cv2.cvtColor(img_c2, cv2.COLOR_BGR2GRAY) # 이미지 그레이스케일
...
try:
    ...
    for i in circles[0]:
        ...
        cv2.rectangle(img_second,(x-25,y-25),(x+25,y+25),(0,0,0),2)
