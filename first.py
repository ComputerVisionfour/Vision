# -*- coding: utf-8 -*-
"""
Created on Thu Oct 21 12:48:18 2021
...
img_color1 = cv.imread('pop_ref_001.jpg', cv.IMREAD_COLOR)
img_color = cv.resize(img_color1, dsize=(640, 480), interpolation=cv.INTER_AREA)
...
dst = cv.Canny(img_gray, 40, 150)

# ret,img_binary = cv.threshold(img_gray, 0, 255, cv.THRESH_BINARY_INV|cv.THRESH_OTSU)
ret,img_binary = cv.threshold(dst, 127, 255, cv.THRESH_BINARY+cv.THRESH_OTSU)
