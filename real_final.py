...
# 이미지 열기
filename = "pop_resize_022.jpg" # 입력 이미지 파일명을 적으세요.

#========================================create List data======
state = [0]*28 # 각 푸시팝의 상태를 데이터 리스트로 저장
...
#sor = np.sort(data)
#print(sor)
print(state) # state가 정상적으로 출력되는지 확인
#================================================알고리즘 출력값 확인==
...
cv2.imshow('visualization', img_c) # 시각화
cv2.imshow('visualization2', tophat) # 시각화
cv2.waitKey(0) 
