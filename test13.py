# -*- coding: utf-8 -*-
"""
Created on Thu Nov 25 00:58:32 2021
...
denoise3 = cv2.medianBlur(erosion_image2, 3)

denoise4 = cv2.medianBlur(img_binary, 3)
#==========================================================

#==========================모폴로지 연산1=======
k = cv2.getStructuringElement(cv2.MORPH_RECT, (50,50))
blackhat = cv2.morphologyEx(denoise4, cv2.MORPH_BLACKHAT, k)
#===============================================
